...
CylinderIdList = _reflection.GeneratedProtocolMessageType('CylinderIdList', (_message.Message,), dict(
...
CylinderId = _reflection.GeneratedProtocolMessageType('CylinderId', (_message.Message,), dict(
...
ParticleDetectorList = _reflection.GeneratedProtocolMessageType('ParticleDetectorList', (_message.Message,), dict(
...
ParticleDetectorData = _reflection.GeneratedProtocolMessageType('ParticleDetectorData', (_message.Message,), dict(
