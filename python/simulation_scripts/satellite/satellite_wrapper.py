...
/npm/satellite/geometry/type tyvek
/npm/visualization false
/npm/satellite/detector single
...
def main():
    ...
    OUTPUT_FILE = "result_detail.hdf5"
    values_macros = {
        "radius" : 0.15,
        ...
        "theta_unit": "degree",
        'energy': np.arange(60.0,80.01, 0.05), # Набор энергий для симуляции
        'number': [1000], # Число событий в одной симуляции
        # 'particle': 'e-'
    ...
    readers = [
        ProtoReader("deposit.proto.bin", proto_convertor=convert_satellite_proto),
        ProtoReader("wrapper_deposit.proto.bin", proto_convertor=convert_satellite_proto)
    ]
